...
const Register = () => {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated) {//true then go to login page
      navigateTo("/");
    }
    console.log("register page useEffect called!")
  }, [error, loading, isAuthenticated, message]);
      ...
      <section className="authPage">
        <div className="container">
          ...
          <form onSubmit={handleRegsiter}>
            ...
            <button style={{ background: "blue" }} type="submit" disabled={loading}>
